    ...
    <div class="flex flex-col gap-6 w-full">
        ...
        <div class="relative overflow-x-auto p-5 flex justify-center">
            ...
            <div class="flex justify-center w-full max-w-screen-md shadow-md sm:rounded-lg p-3">
                <form class="w-full flex flex-col gap-5" action="{{ route('productos.put', $producto->id) }}" method="POST">
                    @csrf
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        {{-- Precio de Compra --}}
                        <div>
                            <label for="precio_compra" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                <p class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Precio de Compra</p>
                            </label>
                        ...
                        {{-- Precio de Venta --}}
                        <div>
                            <label for="precio_venta" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                <p class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Precio de Venta</p>
                            </label>
                    ...
                    <div class="flex justify-end">
                        <button type="submit"
                            class="w-fit text-white bg-slate-700 hover:bg-slate-800 focus:ring-4 focus:outline-none focus:ring-slate-300 font-medium rounded-lg text-sm  px-5 py-2.5 text-center dark:bg-slate-600 dark:hover:bg-slate-700 dark:focus:ring-slate-800">Actualizar</button>
